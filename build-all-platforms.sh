...
# Cross-Platform Build Script for Linux Cute Pet
# This script builds platform-specific executables
...
echo ""
echo "🚀 To test on current platform:"
echo "  ./dist/$(uname -s | tr '[:upper:]' '[:lower:]')-$(uname -m)/PetViewerLinux"
